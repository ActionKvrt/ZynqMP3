...
set ip_repos [list $essentials_dir/vivado-ip $build_dir/ZynqMP3/solution1/impl/ip]

set_property "ip_repo_paths" $ip_repos [current_fileset]
update_ip_catalog

create_ip -name Filter -vendor xilinx.com -library hls -version 1.0 -module_name Filter_0
